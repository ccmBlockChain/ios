...
- (void)setModelA:(QYHangQingModel *)modelA{
    _modelA = modelA;
    NSString *ImageRrl = [NSString stringWithFormat:@"https://raw.githubusercontent.com/iozhaq/image/master/%@.png",modelA.lname];
    [self.iconImageView yy_setImageWithURL:[NSURL URLWithString:ImageRrl] placeholder:[UIImage imageNamed:@"icon_export_logo"]];
    self.titleLable.text = [NSString stringWithFormat:@"%@%@",modelA.lname,modelA.fname];
    self.centerTopLable.text = modelA.latest_price_x;
    self.centerBottomLable.text = modelA.latest_price;
    ...
    self.rightLabel.title = [NSString stringWithFormat:@"%@",modelA.up_down];
