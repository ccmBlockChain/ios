...
- (void)storyboardSubView {
    CustomHomeViewController *home = [[UIStoryboard storyboardWithName:@"Home" bundle:nil] instantiateViewControllerWithIdentifier:@"CustomHome"];
     [self addChildViewController:home imagename:@"icon_wallet" title:@"钱包"];

    [self addChildViewController:[[QYMarketViewController alloc]init] imagename:@"icon_market" title:@"行情"];
    [self addChildViewController:[[QYFoundController alloc]init] imagename:@"icon_found" title:@"发现"];
...
//    [self addChildViewController:[[SKCustomWebViewController alloc]initWithUrl:QYAPI_getStarmoney_Url] imagename:@"icon_found" title:@"发现"];
    ...
    [self addChildViewController:mine imagename:@"icon_user" title:@"我的"];
