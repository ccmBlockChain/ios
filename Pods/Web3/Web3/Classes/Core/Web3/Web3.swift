...
public struct Web3 {
    ...
    public struct Eth {
        ...
        public func syncing(response: @escaping Web3ResponseCompletion<EthereumSyncStatusObject>) {
            let req = BasicRPCRequest(id: properties.rpcId, jsonrpc: Web3.jsonrpc, method: "ccm_syncing", params: [])

            properties.provider.send(request: req, response: response)
        }

        public func mining(response: @escaping Web3ResponseCompletion<Bool>) {
            let req = BasicRPCRequest(id: properties.rpcId, jsonrpc: Web3.jsonrpc, method: "ccm_mining", params: [])

            properties.provider.send(request: req, response: response)
        }

        public func hashrate(response: @escaping Web3ResponseCompletion<EthereumQuantity>) {
            let req = BasicRPCRequest(id: properties.rpcId, jsonrpc: Web3.jsonrpc, method: "ccm_hashrate", params: [])

            properties.provider.send(request: req, response: response)
        }

        public func gasPrice(response: @escaping Web3ResponseCompletion<EthereumQuantity>) {
            let req = BasicRPCRequest(id: properties.rpcId, jsonrpc: Web3.jsonrpc, method: "ccm_gasPrice", params: [])

            properties.provider.send(request: req, response: response)
        }

        public func accounts(response: @escaping Web3ResponseCompletion<[EthereumAddress]>) {
            let req = BasicRPCRequest(id: properties.rpcId, jsonrpc: Web3.jsonrpc, method: "ccm_accounts", params: [])
        ...
        public func getBalance(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getBalance",
                params: [address, block]
            )

            properties.provider.send(request: req, response: response)
        }
        public func getccmBalance(
            address: EthereumAddress,
            block: EthereumQuantityTag,
            response: @escaping Web3ResponseCompletion<EthereumQuantity>
            ) {
        ...
        public func getTransactionCount(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getTransactionCount",
                params: [address, block]
            )
        ...
        public func getethTransactionCount(
            address: EthereumAddress,
            block: EthereumQuantityTag,
            response: @escaping Web3ResponseCompletion<EthereumQuantity>
            ) {
        ...
        public func getBlockTransactionCountByHash(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getBlockTransactionCountByHash",
                params: [blockHash]
            )
        ...
        public func getBlockTransactionCountByNumber(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getBlockTransactionCountByNumber",
                params: [block]
            )
        ...
        public func getUncleCountByBlockHash(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getUncleCountByBlockHash",
                params: [blockHash]
            )
        ...
        public func getUncleCountByBlockNumber(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getUncleCountByBlockNumber",
                params: [block]
            )
        ...
        public func sendRawTransaction(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_sendRawTransaction",
                params: [transaction.rlp()]
            )

            properties.provider.send(request: req, response: response)
        }
        public func sendethRawTransaction(
            transaction: EthereumSignedTransaction,
            response: @escaping Web3ResponseCompletion<EthereumData>
            ) {
            let req = BasicRPCRequest(
        ...
        public func getTransactionByHash(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getTransactionByHash",
                params: [blockHash]
            )
        ...
        public func getTransactionByBlockHashAndIndex(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getTransactionByBlockHashAndIndex",
        ...
        public func getTransactionByBlockNumberAndIndex(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getTransactionByBlockNumberAndIndex",
        ...
        public func getTransactionReceipt(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getTransactionReceipt",
        ...
        public func getUncleByBlockNumberAndIndex(
            ...
            let req = BasicRPCRequest(
                id: properties.rpcId,
                jsonrpc: Web3.jsonrpc,
                method: "ccm_getUncleByBlockNumberAndIndex",
